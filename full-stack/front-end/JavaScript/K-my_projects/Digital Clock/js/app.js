...
// creating a fucntion and calling it in every seconds
...
setInterval(() => {
    ...
    hour = hour > 12 ? hour - 12 : hour; // if hour value is grater than 12 than 12 will substract (by doing this we will get value till 12)
